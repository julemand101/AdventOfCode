...
final input = getInput(2019, 02).readAsStringSync();

void main() {
  group('Part One', () {
    test('Example 1', () {
      expect(
        testParseAndCompute('1,9,10,3,2,3,11,0,99,30,40,50'),
    ...
    test('Example 4', () {
      expect(
        testParseAndCompute('2,4,4,5,99,0'),
        equals(const [2, 4, 4, 5, 99, 9801]),
      );
    });
    test('Example 5', () {
      expect(
        testParseAndCompute('1,1,1,4,99,5,6,0,99'),
        equals(const [30, 1, 1, 4, 2, 5, 6, 0, 99]),
      );
    });
    test('Solution', () {
      expect(solveA(input), equals(4090689));
    });
  });
  group('Part Two', () {
    test('Solution', () {
      expect(solveB(input), equals(7733));
    });
  });
}
