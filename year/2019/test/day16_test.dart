...
import 'package:advent_of_code_2019/day16.dart';
import 'package:test/test.dart';

final input = getInput(2019, 16).readAsStringSync();
...
void main() {
  group('Part One', () {
    ...
    test('Solution', () {
      expect(solveA(input), equals('77038830'));
    });
  });
  group('Part Two', () {
    test('Example 1', () {
    ...
    test('Solution', () {
      expect(solveB(input), equals('28135104'));
    });
  });
}
