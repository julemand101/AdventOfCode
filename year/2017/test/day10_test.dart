...
import 'package:advent_of_code_2017/day10.dart';
...
void main() {
  group('Part One', () {
    test('Example 1', () {
      expect(solveA('3,4,1,5', circularListLength: 5), equals(12));
    });
    test('Solution', () {
      expect(solveA(input, circularListLength: 256), equals(62238));
    });
  });
  ...
  group('Part Two', () {
    ...
    test('Solution', () {
      expect(solveB(input), equals('2b0c9cc0449507a0db3babd57ad9e8d8'));
    });
  });
}
