...
void main() {
  group('Part One', () {
    test('Example 1', () {
      expect(solveA(const ['5 1 9 5']), equals(8));
    });
    test('Example 2', () {
      expect(solveA(const ['7 5 3']), equals(4));
    });
    test('Example 3', () {
      expect(solveA(const ['2 4 6 8']), equals(6));
    });
...
'''
    ...
    test('Solution', () {
      expect(solveA(input), equals(44216));
    });
  });

  group('Part Two', () {
    test('Example 1', () {
      expect(solveB(const ['5 9 2 8']), equals(4));
    });
    test('Example 2', () {
      expect(solveB(const ['9 4 7 3']), equals(3));
    });
    test('Example 3', () {
      expect(solveB(const ['3 8 6 5']), equals(2));
    });
    test('Example Checksum', () {
      expect(
        solveB(
...
'''
    ...
    test('Solution', () {
      expect(solveB(input), equals(320));
    });
  });
}
