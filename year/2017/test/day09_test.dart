...
import 'package:advent_of_code_2017/day09.dart';

final input = getInput(2017, 09).readAsStringSync();
...
void main() {
  group('Part One', () {
    ...
    test('Solution', () {
      expect(solveA(input), equals(14212));
    });
  });
  ...
  group('Part Two', () {
    ...
    test('Solution', () {
      expect(solveB(input), equals(6569));
    });
  });
}
