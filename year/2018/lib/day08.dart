...
// the first element)
int solveA(String input) => Node(parse(input).reversed.toList()).sum;
int solveB(String input) => Node(parse(input).reversed.toList()).value;

List<int> parse(String input) => [...input.split(' ').map(int.parse)];
